...
def setOriginalAudio(filename,tempfile):
    videoclip = VideoFileClip(filename)
    new_clip = videoclip.set_audio(videoclip.audio)
    new_clip.write_videofile(tempfile)
##end def
...
x = 1100#widht
y = 600#height
addImage("sample.mp4","sample - copia.mp4","img.jpg",stime,etime,[x,y])
#setNewAudio("sample.mp4","olas.mp3")